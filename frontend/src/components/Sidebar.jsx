          ...
          return (
            ...
            >
              <div className="relative mx-auto lg:mx-0">
                ...
                {unreadCount > 0 && (
                  <span
                    className="absolute -top-1 -right-1 min-w-[18px] h-[18px] text-[11px] 
                    bg-red-600 text-white rounded-full flex items-center justify-center px-[5px] font-semibold shadow"
                  >
